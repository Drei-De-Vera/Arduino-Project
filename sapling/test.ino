// // Wrapper with default test parameters
// void dispenseTest() {
//   scale.tare();
//   delay(3000);
//   int testPin = AGAR;                 // Replace with actual pin
//   float targetWeight = 75.0;           // Replace with test target weight
//   const char* name = "TEST DISPENSE";   // Test label
//   dispenseTest(testPin, targetWeight, name);
// }
...
// void dispenseTest(int pin, float targetWeight, const char* name) {
//   Serial.print("===");
//   Serial.print(name);
...
//   scale.tare();
//   delay(3000);
//   dispenseTest(COFFEE, 400.0, "COFFEE");
//   coffeeDisplay2();
//   scaleProcess();
// }
...
//   scale.tare();
//   delay(5000);
//   dispenseTest(STARCH, 150, "STARCH");
//   starchDisplay2();
//   scale.tare();
//   delay(5000);
//   agarDisplay1();
//   dispenseUntilWeight(AGAR, 75, "AGAR");
//   agarDisplay2();
//   scaleProcess();
// }
